...
public class NuevoCombo extends JDialog {
	...
	public NuevoCombo() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo   :    Marca    :    Modelo   :   Cantidad    :     Capacidad   "}));
		comboBox.setBounds(122, 31, 371, 20);
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo   :    Marca    :    Modelo   :     Cantidad   :    Velocidad"}));
		comboBox_1.setBounds(122, 77, 371, 20);
		...
		comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo   :    Marca    :    Modelo   :     Cantidad   :    Memoria"}));
		comboBox_2.setBounds(122, 123, 371, 20);
		...
		comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"C\u00F3digo   :    Marca    :    Modelo   :     Cantidad   :    Tipo RAM"}));
		comboBox_3.setBounds(122, 169, 371, 20);
